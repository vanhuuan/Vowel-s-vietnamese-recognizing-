...
function Cal(input_audio)
    ...
    [processedSignal, silence] = process(frames, threshold,ma, min_silence, n_frames, frame_length, Fs);
    %Ve do thi
    draw(processedSignal, y, threshold, ma,silence, frame_du, frame_duration, n_samples, n_frames, Fs,input_audio);
end
...
function [] = draw(processedSignal, y, threshold, ma, silence,frame_du, frame_duration, n_samples, n_frames, Fs,name)
